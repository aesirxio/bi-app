      ...
      paginationHTML.push(
        <button
          ...
          className={`btn ${styles.btn} border-1 border-gray p-0 fs-6 rounded-circle ${
            i === currentNumber ? 'active bg-green text-white border-green' : ''
          } ${
            i === currentNumber - 1 ||
            i === currentNumber - 2 ||
            i === currentNumber - 3 ||
      ...
      <div className={'ps-3 col-md-12 d-flex justify-content-center'}>
        ...
        {pagination && pagination.totalPages > 1 && (
          <button
            ...
            className={`btn ${styles.btn} border-1 border-gray p-0 fs-6 rounded-circle ${
              1 === pagination.page ? 'active bg-green text-white border-green' : ''
            }`}
          >
        ...
        <p
          className={`mb-0 d-flex align-items-end ms-2 me-2 fs-5 rounded-circle opacity-50 ${
            pagination.page === 1 ||
            pagination.page === 2 ||
            pagination.page === 3 ||
            pagination.page === 4 ||

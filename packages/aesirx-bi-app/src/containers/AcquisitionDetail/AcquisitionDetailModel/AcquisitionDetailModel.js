...
class AcquisitionDetailModel {
  ...
  toAreaChart = () => {
    ...
    const month = twelveMonth.map((month, index) => {
      ...
      return {
        ...
        acquisition_views: totalPageViewCount,
    ...
    dateRange.forEach((date) => {
      ...
      if (filterWeekDate) {
        ...
        weekData[weekName].acquisition_views += totalPageViewCount;
    ...
    const week = Object.keys(weekData).map((weekName) => ({
      ...
      acquisition_views: weekData[weekName].acquisition_views,
  ...
  toSourcesTableTopAcquisitionDetail = () => {
